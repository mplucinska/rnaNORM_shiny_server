...
//            else sequenceOptions = options;
            ...
            sequenceOptions.header = options.header ? {
                ...
                unit : options.header.unit === undefined ? "Nucleotides" : options.header.unit,
            ...
            } : {display : true, searchInTitle : true, unit : "Nucleotides", showCpl: true, badgeWithUnit: false};
            ...
            var sources = header +
                "<div class=\"sequenceBody\" style=\"margin-top: 0px;\">" +
                ...
                "<div class=\"coverageLegend\" style=\"margin-top: 0px;margin-left:15px;\"></div>" +
                "</div>";
            ...
            if (sequenceOptions.toolbar) {
                if (sequenceOptions.header.showCpl){
                    ...
                    var source = "<form class=\"form-inline\" style=\"margin-bottom:0px;\">" +
...
//                "<div class=\"input-group input-group-sm\" style=\"margin-left:20px;\"> <span class=\"input-group-addon charPerLine-label\">Nucleotides per line</i></span>" +
//
...
//              "<div class=\"sequenceToolbar row\" style=\"margin-bottom:15px;\">" +
                "<div class=\"form-group form-group-sm sequenceToolbar\" style=\"\"> "+
                    ...
                    "<select class=\"CPLChoice form-control " + hidexsCharPerLine + "\" id='"+ divID.substring(1) +"-cpl' style='display:inline-block;width:auto;margin-right:10px;background-color:white'>" +
                        "<option>Select</option>" +
                        "<option value=50>50</option>" +
                        "<option value=60>60</option>" +
                        "<option value=70>70</option>" +
